...
public class GeradorDePagamentoTest {
	...
	public void deveGerarPagamentoParaUmLeilaoEncerrado() {
		...
		Leilao leilao = new CriadorDeLeilao().para("Video game").lance(new Usuario("Juca"), 2000.0)
				.lance(new Usuario("Jarbas"), 2500.0).constroi();
	...
	@Test 
	public void empurraDataParaProximoDiaUtil() {
		RepositorioDeLeiloes leiloes = mock(RepositorioDeLeiloes.class);
		RepositorioDePagamentos pagamentos = mock(RepositorioDePagamentos.class);
		Relogio relogio = mock(Relogio.class);
		
		Leilao leilao = new CriadorDeLeilao().para("Tv").lance(new Usuario("Jose"), 2000.00).lance(new Usuario("Maria"), 2500.00).constroi();
	...
	@Test 
	public void empurraDataParaProximoDiaUtil2() {
		RepositorioDeLeiloes leiloes = mock(RepositorioDeLeiloes.class);
		RepositorioDePagamentos pagamentos = mock(RepositorioDePagamentos.class);
		Relogio relogio = mock(Relogio.class);
